import type { Editor, MarkdownFileInfo, MarkdownView, App } from "obsidian";
...
export const insertMultiSceneTemplate: CommandBuilder = (_plugin) => ({
  ...
  editorCheckCallback(checking, editor, view) {
    return callbackForFormat("scenes", checking, editor, view, _plugin.app);
  },
});
...
export const insertSingleSceneTemplate: CommandBuilder = (_plugin) => ({
  ...
  editorCheckCallback(checking, editor, view) {
    return callbackForFormat("single", checking, editor, view, _plugin.app);
  },
});
